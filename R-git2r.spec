...
Patch1: backport-partial-drop-on-update.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722369837
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/git2r/libs/git2r.so
/V4/usr/lib64/R/library/git2r/libs/git2r.so
