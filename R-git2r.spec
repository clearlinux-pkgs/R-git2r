...
Version  : 0.19.0
Release  : 46
URL      : https://cran.r-project.org/src/contrib/git2r_0.19.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/git2r_0.19.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1502405179
